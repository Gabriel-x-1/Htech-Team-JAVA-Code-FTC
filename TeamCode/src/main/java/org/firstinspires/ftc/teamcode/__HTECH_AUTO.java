...
@Config
public class __HTECH_AUTO extends LinearOpMode
{
    public static int MAX_CONES = 5;
    
    public static Pose2d START_POSE = new Pose2d(35.75, -62, Math.toRadians(90));
    public static Pose2d HIGH_JUNCTION = new Pose2d(29, -10, Math.toRadians(127.17570686340325));
    public static Pose2d SUBSTATION = new Pose2d(43, -15, Math.toRadians(180));
...
//        telemetry = new MultipleTelemetry(telemetry, FtcDashboard.getInstance().getTelemetry());
    ...
    public TrajectorySequence buildMainTrajectory()
    {
        ...
        mainTrajectoryBuilder
                ...
                {
                    if (preloadOnHigh) hardware.glisVert.moveToHigh();
                    else hardware.glisVert.moveToMid();
                })
                ...
                .UNSTABLE_addTemporalMarkerOffset(1.5, () -> //0 before
                {
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> //0.4
                {
        ...
        if (doCycling)
        {
            ...
            for (int i = 5; i > 5 - MAX_CONES; i--)
            {
                ...
                mainTrajectoryBuilder
                        ...
                        .UNSTABLE_addTemporalMarkerOffset(0, () ->
                        {
                            hardware.bratCleste.moveToGrab(n);
                            if(n == 5) hardware.glisOriz.moveToMax(350);
                            else if(n == 4) hardware.glisOriz.moveToMax(400);
                            else hardware.glisOriz.moveToMax(400);
                        })
                        .waitSeconds(0.6)
                        .UNSTABLE_addTemporalMarkerOffset(0, () ->
                        {
                        ...
                        .UNSTABLE_addTemporalMarkerOffset(0, () ->
                        {
                            ...
                            hardware.bratCleste.moveToClear();
                        })
                        ...
                        {
                            hardware.cleste.open(); //cade con in sleeve
                        })
                ...
                mainTrajectoryBuilder
                        ...
                        .UNSTABLE_addTemporalMarkerOffset(0, () ->
                        {
                            if (placeOnHigh) hardware.glisVert.moveToHigh();
                            else hardware.glisVert.moveToMid();
                        ...
                        .lineToLinearHeading(maybeMirror(placeOnHigh ? (m > 0 ? HIGH_JUNCTION.plus(new Pose2d(0, -2, Math.toRadians(2 * m))) : HIGH_JUNCTION) : MID_JUNCTION, true))
